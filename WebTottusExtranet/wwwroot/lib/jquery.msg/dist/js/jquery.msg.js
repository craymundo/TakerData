    ...
    $.msg = function () {
        ...
        _ = {
            ...
            unblock: function () {
                ...
                var cantidad = $('#jquery-msg-overlay').length;
                for (var i = 1; i <= (cantidad + 2); ++i) {
                    if ($('#jquery-msg-overlay').length) {
                        $overlay = $('#jquery-msg-overlay').fadeOut(configs.fadeOut);
                ...
                //$('#jquery-msg-overlay').each(function () {
                //    $overlay = $(this).fadeOut(configs.fadeOut, function () {
                //        // beforeUnblock event callback
                //        beforeUnblock[configs.msgID]($overlay);
                //        $overlay.remove();
                //    });
        ...
        if (type === '[object String]') {
            ...
            $overlay.
                ...
                fadeIn(configs.fadeIn, function () {
                    ...
                    $content.fadeIn('fast').children().bind('click', function (e) {
                        e.stopPropagation();
                    });
